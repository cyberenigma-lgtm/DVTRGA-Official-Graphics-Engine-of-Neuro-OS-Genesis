...
echo [2.5/4] Compilando STRESS TEST (dvtrga_stress_test.c) [OPENMP ENABLED]...
cl /O2 /openmp /arch:AVX2 /fp:fast /favor:INTEL64 dvtrga_stress_test.c dvtrga_api.lib user32.lib gdi32.lib
if %errorLevel% neq 0 (
    echo [X] Error compilando stress test
    pause
    exit /b 1
)
echo [OK] Stress Test compilado
echo.
